...
# Fold-change analysis on uploaded data, unpaired
...
mSet<-PlotStaticCorrHeatMap(mSet, "corr_0_", "png", 72, width=NA, "col", "pearson", "bwm", "overview", F, F, 0.0)
# OPTION 2 - Heatmap specifying pearson correlation and a detailed view
mSet<-PlotStaticCorrHeatMap(mSet, "corr_1_", format = "png", dpi=72, width=NA, "col", "spearman", "bwm", "detail", F, F, 999) # 0.0
...
mSet<-PlotStaticHeatMap(mSet, "heatmap_0_", "png", 72, width=NA, "norm", "row", "euclidean", "ward.D","bwm", 8, "overview", T, T, NULL, T, F, T, T, T)
